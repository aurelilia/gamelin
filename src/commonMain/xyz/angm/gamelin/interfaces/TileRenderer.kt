...
/** Represents the canvas the system's LCD is displayed on. Used for both the console
 * LCD as well as some graphical debugging tools.
...
internal expect class TileRenderer(tileWidth: Int, tileHeight: Int) {
    ...
    /** Called when VBLANK occurs and a full frame has rendered, to allow the renderer to push it to the screen. */
    fun finishFrame()
    /** Dispose all underlying resources like pixmaps or textures. */
    fun dispose()
}